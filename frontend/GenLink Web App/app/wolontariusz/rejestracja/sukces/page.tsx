      ...
      <Card className="border border-default-100 bg-default-50 shadow-medium">
        <CardHeader className="flex flex-col gap-2 text-left">
          ...
          <p className="text-sm text-default-600">
            Możesz się teraz zalogować i rozpocząć wsparcie seniorów przez
            platformę GenLink.
          </p>
        </CardHeader>
        <Divider />
        <CardBody className="space-y-3 text-sm text-default-600">
          <p>
            Witaj w społeczności GenLink. W zakładce <strong>Panel</strong>{" "}
            znajdziesz zgłoszenia seniorów, a w <strong>Ustawieniach</strong>{" "}
            możesz zgłosić swoją dostępność.
          </p>
        </CardBody>
        <Divider />
        <CardFooter>
