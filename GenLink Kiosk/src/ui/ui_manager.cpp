...
UIManager::UIManager()
    : active_screen_(nullptr), pending_screen_(nullptr), display_(nullptr), touch_(nullptr), initialized_(false), last_touch_state_(false)
{
}
...
bool UIManager::initialize()
{
    ...
    // Inject manager references to already registered screens
