...
NfcManager::NfcManager()
    : nfc_(nullptr), initialized_(false), card_present_(false), last_card_present_(false), last_read_time_(0), on_card_detected_(nullptr), on_card_removed_(nullptr), firmware_version_major_(0), firmware_version_minor_(0)
{
}
