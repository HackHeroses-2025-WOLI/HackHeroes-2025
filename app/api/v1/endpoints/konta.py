...
from app.core.security import create_access_token, get_current_konto
...
@router.get(
    ...
    description="Pobierz dane swojego konta (wymaga autoryzacji)"
)
def get_my_konto(
    current_konto: Konto = Depends(get_current_konto)
):
    """Zwróć konto powiązane z tokenem dostępowym."""
    return current_konto
